        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="#"
                    ...
                    <span class="ms-3">User Dashboard</span>
                </a>
            </li>
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Candidate Application</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Investor Application</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Candidate Features</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
            ...
            <li>
                <button type="button"
                    ...
                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Investor features</span>
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="m1 1 4 4 4-4" />
